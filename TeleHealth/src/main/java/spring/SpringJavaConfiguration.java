...
public class SpringJavaConfiguration {
	...
	public SessionFactory sessionFactory() {
		...
		//此處加入相關的Bean  例如MemberBean.class等，中間用"逗號,"隔開
		builder.addAnnotatedClasses(AdvisoryMomentBean.class,AdvisoryTypeBean.class,EmployeesBean.class,DataAnalysisBean.class,HealthColumnBean.class,QuestionBean.class,AdvisoryBean.class,BMIBean.class);		
