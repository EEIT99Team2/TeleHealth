			...
			<div class="col-6">
				<div class="from-group">
					<form method="post"
						...
						<div class="row">
							<label for="oldpwd">請輸入原密碼：</label> <input type="password"
								name="oldpwd" id="oldpwd" value="${param.oldpwd}"
								class="fieldWidth" style="width: 320px;" required> <span
								id="checkOldpwd"></span>
						</div>
						<div class="row">
							<p></p>
						...
						<div class="row">
							<label for="Newpwd">請輸入新密碼：</label> <input type="password"
								name="Newpwd" id="Newpwd" value="${param.Newpwd}"
								class="fieldWidth" style="width: 320px;" required> <span
								id="checkNewpwd"></span>
						</div>
						<div class="row">
						...
						<div class="row">
							<label for="pwdCheck">請再輸入一次：</label> <input type="password"
								name="pwdCheck" id="pwdCheck" value="${param.pwdCheck}"
								class="fieldWidth" style="width: 320px;" required> <span
...
$('#Newpwd').blur(function(){
	...
	if(Newpwd !==null && Newpwd.length>0){
		if( Newpwd == oldpwd){
			checkNewpwd.html("<img src=images/error.png>"+"不能與舊密碼相同!");
			$('#submitBtn').prop("disabled", true);
			}else{
		checkNewpwd.empty();
