        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">About TeleHealthSystem</h3>
                    <p class="text-justify">本平台為了打造個人化的遠距健康諮詢平台，結合遠距視訊健康諮詢網路與各項健康數據分析，由牽伴醫護團隊協助分析各項生理數據，
                    	更進一步提供相關預防保健管理建議 ，對於自身生理數值有任何疑問，皆可隨時預約諮詢個案管理師，個案管理師亦會針對每日量測的數值主動進行監測及相關照護，此項服務可讓個案在家就能獲得立即且持續的照護與諮詢，
